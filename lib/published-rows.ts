...
async function build(): Promise<PublishedRowsData> {
  ...
  // Tickers come from the asset lane through the same rule the company
  // pages use (Sept. 7, 2026): top tier plus the name gate. Before this the
  // box used the older printed-symbol matcher, so "who traded Microsoft"
  // here and on /companies/msft could disagree.

...
Rows by verification state: 32,633 checked; 165 human_verified; 5 deterministic_agree; 0 two_models_agree; 0 audit_only; 0 single_read; 5 implausible; 0 disputed. Counts are checked against `data/meta/row-verification.json` at test time.
